      ...
      <div class="container" >
        <div class="row">
            <div class="col-sm-6">
              ...
              <div class="col-sm-12" style="text-align:left; margin-left:20px;" ><bold style="font-size:20px">Telefon: </bold>062/281-493</div>
              <div class="col-sm-12" style="text-align:left; margin-left:20px;" ><bold style="font-size:20px">Email: </bold>vokakop@gmail.com</div>
            </div>
            <div class="col-sm-6">
...
export default {
  ...
  methods:{
    ...
    submitForm(){
      this.$axios.post("http://localhost/mail/mailto.php", this.form)
          .then((response) => {
